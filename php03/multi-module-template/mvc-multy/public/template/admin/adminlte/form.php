                ...
                <div class="container-fluid">
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="text-white"><b>Ordering:</b> Phải từ 1 đến 15!</li>
                        </ul>
                    </div>
                    <div class="card card-info card-outline">
                        <div class="card-body">
                            <form action="" method="post" class="mb-0" id="admin-form">
                                ...
                                <div class="form-group row">
                                    <label for="ordering" class="col-sm-2 col-form-label text-sm-right">Ordering</label>
                                    <div class="col-xs-12 col-sm-8">
                        ...
                        <div class="card-footer">
                            <div class="col-12 col-sm-8 offset-sm-2">
                                ...
                                <a href="list.php" class="btn btn-sm btn-danger mr-1"> Cancel</a> </div>
                        </div>
                    </div>
                </div>
            </section>
