        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-2">
            <div class="mb-1">
                <?php
                    ...
                    $selectboxAction	= Helper::cmsSelectbox('bulk_action', 'custom-select custom-select-sm mr-1', $arrAction, $arr, 'width: unset');

                    // Button Apply
                    $linkApply          = URL::createLink($module, $controller, $arr, array('type' => '1'));
                    ...
                    <?php
                        if(!empty($this->Items)){
                            ...
                            foreach($this->Items as $key => $value){
                                $id 		 = $value['id'];
                                $ckb		= '<input type="checkbox" id="checkbox-'.$id.'" class="custom-control-input" name="cid[]" value="'.$id.'">';
