...
class Helper{
	...
	public static function cmsGroupACP($groupAcpValue, $link, $id){
		...
		$classI 	= ($groupAcpValue == 1) ? 'check' : 'minus';
	
		$xhtml			= '<a class="my-btn-state rounded-circle btn btn-sm btn-'.$classA.'" id="group-acp-'.$id.'" href="javascript:changeGroupACP(\''.$link.'\');">
