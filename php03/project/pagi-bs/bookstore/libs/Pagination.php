...
class Pagination{
	...
	public function __construct($totalItems, $pagination){
		...
		// echo $this->totalItems . 'totalItems<br>';
		// echo $this->totalItemsPerPage . 'totalItemsPerPage<br>';
		// echo $this->pageRange . 'pageRange<br>';
		// echo $this->totalPage . 'totalPage<br>';
		// echo $this->currentPage . 'currentPage<br>';
	...
	public function showPagination($link){
		...
		if($this->totalPage > 1){
			...
			if($this->currentPage > 1){
				$start 	= '<li class="page-item enable"><a href="'.$link.'&page=1" class="page-link">
				<i class="fas fa-angle-double-left"></i></a></li>';
				$prev 	= '<li class="page-item enable"><a href="'.$link.'&page='.($this->currentPage-1).'" class="page-link">
			...
			if($this->currentPage < $this->totalPage){
				$next 	= '<li class="page-item"><a class="page-link" href="'.$link.'&page='.($this->currentPage+1).'">
				<i class="fas fa-angle-right"></i></a></li>';
				$end 	= '<li class="page-item"><a class="page-link" href="'.$link.'&page='.($this->totalPage).'">
