...
<?php
    ...
    function createSelecBox($name, $attributes, $array, $keySelect) {
        $xhtml = "";
        if (!empty($array)) {
    ...
    $groupSelect = createSelecBox("group", "width: 200px", $group, 4);
    $citySelect  = createSelecBox("city", "width: 300px", $city, "tg");
